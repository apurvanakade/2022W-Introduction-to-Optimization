...
Consider a primal-dual dictionary dictionary pair:
  ...
  \end{align*}
  \begin{enumerate}
    \item Perform a pivot with $x_1$ entering and $x_3$ leaving on the primal.
    \item Perform a pivot with $y_3$ entering and $y_1$ leaving on the dual. 
  \end{enumerate}
  Verify that after the pivots the dual dictionary is still negative transpose of the primal. 
  There is nothing special about one equation and three variables. This proof completely generalizes to any number of equations and variables.
:::
