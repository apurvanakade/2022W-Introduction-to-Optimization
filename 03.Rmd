...
The first, and arguably the most important trick in the simplex method is the introduction of *slack variables*  $x_3$ and $x_4$, one for each constraint, as shown below, to create a new linear program called a *dictionary* which is equivalent to \@ref(eq:simplex-example)
