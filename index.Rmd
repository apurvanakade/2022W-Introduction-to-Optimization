...
Most of this course is about Linear Programming. In the first half, we'll study the simplex method, which is an algorithm for solving linear programs, and the in the second half we'll study the theory behind linear programs using duality theory.